...
working_dir = '../../../results/pymvpa_LOO'
saving_dir = '../../../results/MRI/pymvpa/LOO stats 4 models'
figure_dir = '../../../figure/MRI/pymvpa/LOO 4 models'
...
title = 'within subject decoding, fold = LOO'
