...
decoding pipeline with multiple models and multiple rois, using leave one day out (6 folds)
...
from utils                   import groupy_average,build_model_dictionary
