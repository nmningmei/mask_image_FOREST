...
file_name = '../../../data/MRI/sub-01/func/session-02/sub-01_unfeat_run-02/outputs/func/ICA_AROMA/denoised_func_data_nonaggr.nii.gz'
...
if not os.path.exists(output_dir):
    os.mkdir(output_dir)
highpass_workflow = create_highpass_filter_workflow(HP_freq = HP_freq, TR = TR)
