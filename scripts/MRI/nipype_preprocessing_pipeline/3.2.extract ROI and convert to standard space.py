...
sub = 'sub-01'
first_session = 2
os.environ['SUBJECTS_DIR'] = os.path.abspath('/export/home/nmei/nmei/MRI/uncon_feat/MRI/{}/'.format(sub))
in_file = os.path.abspath('/export/home/nmei/nmei/MRI/uncon_feat/MRI/{}/anat/{}/mri/aparc+aseg.mgz'.format(sub,sub))
original = os.path.abspath('/export/home/nmei/nmei/MRI/uncon_feat/MRI/{}/anat/{}/mri/orig/001.mgz'.format(sub,sub))
ROI_standard_dir = '/export/home/nmei/nmei/MRI/uncon_feat/MRI/{}/anat/ROIs_anat'.format(sub)
...
anat_dir = '/export/home/nmei/nmei/MRI/uncon_feat/MRI/{}/anat'.format(sub)
ROI_in_structural = glob(os.path.join(anat_dir,'ROIs_anat','*fsl.nii.gz'))


preprocessed_functional_dir = '/export/home/nmei/nmei/MRI/uncon_feat/MRI/{}/func/session-0{}/{}_unfeat_run-01/outputs'.format(
        sub,first_session,sub)

output_dir = os.path.join(anat_dir,'ROI_standard')
