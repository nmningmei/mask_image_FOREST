...
for k in [1,2,3,4,5,6,7]:
    ...
    univariate_test_dir = f'../../../../results/MRI/nilearn/univariate_test_full/{sub}'
    ...
    standarded_dri = f'../../../../results/MRI/nilearn/RSA_searchlight_standarded_full/{sub}'
    figure_dir = f'../../../../figures/MRI/nilearn/RSA_searchlight_6mm/'
    ...
    figure.savefig(os.path.join(
        ...
        f'RSA_searchlight_{sub}_full.png'),
        dpi = 400,
        bbox_inches = 'tight')
    figure.savefig(os.path.join(
        figure_dir,
