...
# -*- coding: utf-8 -*-
"""
Created on Fri Oct  4 11:55:22 2019
...
template = 'temporal_generalization.py'
output_dir = '../temporal_genralization_bash'
...
for ii,BOLD_data_file in enumerate(BOLD_data):
    target_file = f'{template.split(".")[0]}_{ii + 1}.py'
...
"""
    print(content)
    bash_file_name = f'decode_{ii+1}_q'
